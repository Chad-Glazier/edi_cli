...
If you want to watch some robots play the game in your terminal and help collect data, feel free to install this tool. At the time of writing, it can only be installed via the `go` CLI, which you can download from [here](https://go.dev/). Once you have Go installed, you can get the EDI CLI tool from here:
